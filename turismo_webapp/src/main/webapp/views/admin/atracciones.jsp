...
<body class="bg-general">
	...
	<div class="container contenedor" style="color: black;">
			  ...
			  <div class="accordion-item">
			    ...
			    <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
				      <div class="accordion-body bodyacordeon">
				      	<form action="/turismo_webapp/tipos/create.do" method="post" class="adminform">
		...
		<!-- opciones deberian ser sacadas de bdd -->
				      		...
				      		para m&aacute;s informaci&oacute;n <a href="/turismo_webapp/administrador/ver.do" target="blank">consulte las atracciones</a></p><br>
